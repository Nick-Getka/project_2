...
\COPY product(product_category, product_name, product_description, price, option_value, nothing_useful, product_option) FROM 'final-data/products.dat' WITH CSV HEADER DELIMITER '|'
